...
#TODO https://thomasthornton.cloud/2025/05/15/deploy-terraform-to-azure-with-oidc-and-github-actions/
#TODO  Configuration
...
# TODO Verify Azure CLI is installed and user is logged in
...
#TODO  Check if Azure AD App already exists
...
if [ "$APP_EXISTS" = "$APP_DISPLAY_NAME" ]; then
    ...
    #TODO  Create Azure AD application registration
...
#TODO  Check if service principal exists
...
#TODO  Function to create or update federated credential
...
#TODO  Create federated credentials for different GitHub workflows
